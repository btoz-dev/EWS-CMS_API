...
@section('content')
    <div class="container">
        ...
        <div class="card rounded-0">
          <h5 class="card-header">Packing House Tandan Bonggol Report</h5>
          <div class="card-body">
            ...
            <table class="table table-striped table-sm" id="data-table">
                <thead>
                    <tr>
                        ...
                        <th>Berat Bonggol</th>
                        <th>Berat Bersih</th>
                        <th>Catatan Tandan</th>
                        <th>Catatan Bonggol</th>
                        <th>Tanggal Timbang Tandan</th>
                        <th>Tanggal Timbang Bonggol</th>
                        <th>Pencatat Tandan</th>
                        <th>Pencatat Bonggol</th>
                        <th>TK Tandan</th>
                        <th>TK Bonggol</th>
                    </tr>
                </thead>
